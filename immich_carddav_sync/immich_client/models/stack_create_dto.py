...
T = TypeVar("T", bound="StackCreateDto")
...
class StackCreateDto:
    """
    Attributes:
        asset_ids (List[UUID]): first asset becomes the primary
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stack_create_dto = cls(
            asset_ids=asset_ids,
        )

        stack_create_dto.additional_properties = d
        return stack_create_dto
