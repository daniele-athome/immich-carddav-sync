...
def _get_kwargs(
    *,
    ...
    type: Union[Unset, None, ReactionType] = UNSET,
    level: Union[Unset, None, ReactionLevel] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        type (Union[Unset, None, ReactionType]):
        level (Union[Unset, None, ReactionLevel]):
